...
def estimate(s):
    if s == '':
        ...
        try:
            ...
            messagebox.showinfo('info', 'Model files not found. Please run the notebook to train the model first.')
            return
        ...
        try:
            ...
            messagebox.showinfo('info', f'Database update failed: {str(e)}')
def login():
    user = a1.get()
    password = a2.get()
    a1.set('')
    ...
    if (user == 'abc') and (password == '12345'):
        ...
        def disp():
            ...
            try:
                ...
                messagebox.showinfo('info', f'Database connection failed: {str(e)}')
